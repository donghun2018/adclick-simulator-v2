...
from ssa_sim_v2.simulator.modules.click_probability.click_probability_base_module import ClickProbabilityModule

# ------------------------------------------------------------

    
class ClickProbabilityDateHoWModule(MultiStateSimulatorModule):
    """
    ...
    def __init__(self, priors=None, base_classes=None, seed=9):
        ...
        self.models = {}  # type: Dict[str, ClickProbabilityModule]

        super().__init__(priors, base_classes, seed)

    def get_cp(self, bid=np.random.uniform(low=0, high=20), date="2015-01-05", how=0, attr=(0,)):
        """
        ...
        return self.models["{}.{}".format(date, how)].get_cp(bid, attr)
