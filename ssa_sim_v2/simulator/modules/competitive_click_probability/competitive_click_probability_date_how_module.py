...
from ssa_sim_v2.simulator.modules.competitive_click_probability.competitive_click_probability_base_module import CompetitiveClickProbabilityModule
...
class CompetitiveClickProbabilityDateHoWModule(MultiStateSimulatorModule):
    """
    Module for the bid->click probability relation using a model specified during initialization. 
    ...
    def __init__(self, priors=None, base_classes=None, seed=9):
        ...
        self.models = {}  # type: Dict[str, CompetitiveClickProbabilityModule]

        super().__init__(priors, base_classes, seed)

    def get_cp(self, auction_results, date="2015-01-05", how=0, attr=(0,)):
        """
        ...
        return self.models["{}.{}".format(date, how)].get_cp(auction_results, attr)
...
if __name__ == "__main__":
    ...
    class TestClickProbabilityDateHoW(unittest.TestCase):
        def test_sanity(self):
            ...
            click_prob_model = ClickProbabilityDateHoW(priors, base_classes, seed=9)
